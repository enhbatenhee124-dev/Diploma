...
### View-үүдийн эрхийн горим

Supabase-ийн шалгагч `SECURITY DEFINER view` талаар анхааруулга өгдөг.
Энэ төсөлд тэдгээр нь **зориудын** бөгөөд хоёр бүлэгт хуваагдана.

**1. Эмзэг өгөгдөлтэй — `security_invoker = on`**

`invoice_overview`, `employer_queue`

Хамгаалалт **хоёр давхар**: view дотор `where ... auth.uid() or is_admin()`,
дээр нь доод хүснэгтийн RLS. Аль нэг нь алдагдсан ч нөгөө нь барина.

⚠ `WHERE` нөхцөлийг бүү устга. RLS үлдэх ч зөвхөн `invoices`-д хамаарна —
`profiles`-оос ирэх утас, и-мэйл нь тусдаа хамгаалалт шаардана.

`tests/api.test.js` → "Definer view-үүдийн мөрийн шүүлт" хэсэг шалгана:
ажилтан 0 нэхэмжлэл, ажил олгогч зөвхөн өөрийнх, админ бүгд.

**2. Зориуд нийтийн — definer шаардлагатай**

`public_profiles`, `public_shifts`, `public_employers`, `rankings`,
`user_progress`, `user_stats`, `visible_reviews`

Эдгээр нь **баганаараа** хамгаалагдана: утас, и-мэйл, регистр, хаяг огт
ороогүй.

Definer горим нь эдгээрт **зайлшгүй**. Доод хүснэгтээс дүр бүр юу уншиж
чадахыг хэмжвэл:

| Хүснэгт | нийт | зочин | ажилтан | админ |
|---|---|---|---|---|
| `profiles` | 12 | 0 | **1** | 12 |
| `shifts` | 5 | **0** | 4 | 5 |
| `applications` | 4 | 0 | **2** | 4 |

Invoker горимд шилжвэл: зочин зар харахаа болино (нийтийн самбар үхнэ),
ажилтан зөвхөн ӨӨРИЙН профайлыг харна (бусдын нэр алга), `rankings` нь
дуусгасан ажлыг тоолж чадахгүй (тэргүүлэгчид үхнэ).

⚠ Supabase Advisor эдгээрийг CRITICAL гэж тэмдэглэсээр байх болно. Энэ нь
**загварын ерөнхий анхааруулга** — эмзэг багана байхгүй тул задрал биш.
Шинэ багана нэмэхээсээ өмнө "үүнийг Google индексжүүлж болох уу?" гэж асуу.
