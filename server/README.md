...
**1. Эмзэг өгөгдөлтэй — мөрийн шүүлт нь view дотор**

`invoice_overview`, `employer_queue`

Эдгээр нь `profiles`-оос уншдаг. `security_invoker = on` үед `profiles`-ийн
хатуу RLS-ээс болж **админд ч хоосон** харагдана (JOIN нурна). Тиймээс
эзэмшигчийн эрхээр ажиллуулж, мөрийн шүүлтийг view-ийн `WHERE`-т хийсэн:

```sql
where i.employer_id = auth.uid() or public.is_admin()
```

⚠ **Энэ нөхцөлийг хэзээ ч бүү устга.** Устгавал бүх ажил олгогчийн
нэхэмжлэл, утас, и-мэйл, регистрийн дугаар задарна. RLS барихгүй —
эзэмшигчийн эрхээр ажиллаж байгаа тул.

`tests/api.test.js` → "Definer view-үүдийн мөрийн шүүлт" хэсэг үүнийг
шалгана: ажилтан 0 нэхэмжлэл, ажил олгогч зөвхөн өөрийнх, админ бүгд.

**2. Зориуд нийтийн — шүүлт шаардлагагүй**
...
ороогүй. Definer горим нь зайлшгүй — жишээ нь `rankings` нь бүх хэрэглэгчийн
дуусгасан ажлыг тоолох ёстой, гэтэл RLS нь дуудагчид бусдын хүсэлтийг
харуулдаггүй.

⚠ Эдгээрт **шинэ багана нэмэхээсээ өмнө** "үүнийг Google индексжүүлж болох
уу?" гэж асуу.
